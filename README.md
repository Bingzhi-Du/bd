# Big data engineering(BDE) notebook
  # tools of BDE introduction installation
    ...
    # Pyspark on win
      ...
      # Spark runs on Java 8/11/17, Scala 2.12/2.13, Python 3.8+, and R 3.5+ (3.5version)>>> https://spark.apache.org/docs/latest/index.html
      ...
      # scala & spark matched version check >>> https://mvnrepository.com/artifact/org.apache.spark/spark-core
      # 
